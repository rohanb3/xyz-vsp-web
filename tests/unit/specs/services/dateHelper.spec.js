...
describe('dateHelper', () => {
  ...
  describe('correctDateFault', () => {
    it('should return correct date for passed fault and entities with positive seconds', () => {
      expect(correctDateFault('2020-03-10T00:00:00Z', 5, 'seconds')).toBe('2020-03-10T00:00:05Z');
    });
    it('should return correct date for passed fault and entities with positive minutes', () => {
      expect(correctDateFault('2020-03-10T00:00:00Z', 5, 'minutes')).toBe('2020-03-10T00:05:00Z');
    });
    it('should return correct date for passed fault and entities with negative hours', () => {
      expect(correctDateFault('2020-03-10T00:00:00Z', -5, 'hours')).toBe('2020-03-09T19:00:00Z');
    });
    it('should return correct date for passed fault and entities with positive days', () => {
  ...
  describe('getDifference', () => {
    it('should return correct negative difference between dates ', () => {
      expect(getDifference('2020-03-10T00:00:00Z', '2020-03-10T00:03:00Z')).toBe(-180000);
    });
    it('should return correct negative difference in milliseconds between dates', () => {
      expect(getDifference('2020-03-10T00:00:00Z', '2020-03-10T00:03:00Z', 'seconds')).toBe(-180);
    });
    it('should return correct negative difference in minutes between dates', () => {
      expect(getDifference('2020-03-10T00:00:00Z', '2020-03-10T00:03:00Z', 'minutes')).toBe(-3);
    });
    it('should return correct positive difference in hours between dates', () => {
